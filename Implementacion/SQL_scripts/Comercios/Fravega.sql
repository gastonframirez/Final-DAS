...
go
-- insert into ofertas values (getdate(), getdate()+100, 'https://www.garbarino.com/listado/ofertas-televisores-4274/cbvl', 'https://gastonframirez.github.io/cdnDAS/offers/fravega1.jpg', 1);
-- go
----------------------------------------------------------------------------------------------
